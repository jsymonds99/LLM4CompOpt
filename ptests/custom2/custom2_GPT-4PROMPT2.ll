...
4:                                                ; preds = %16, %3
  %5 = phi double [ %17, %16 ], [ -1.000000e+09, %3 ]
  %6 = phi i32 [ %18, %16 ], [ -10, %3 ]
  %7 = icmp slt i32 %6, 11
...
32:                                               ; preds = %29, %26
  ...
  %39 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, double noundef %38) #3
  %40 = call double @find_min(double noundef %35, double noundef %36, double noundef %37)
  %41 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, double noundef %40) #3

...
5:                                                ; preds = %3
  tail call void @doTest(i64 noundef %.0)
  br label %6
...
define internal void @doTest(i64 noundef %0) #0 {
  ...
  %5 = mul i64 %4, 16
  %6 = mul i64 2, %5
  %7 = tail call ptr @malloc(i64 noundef %6) #5
  br label %8
...
10:                                               ; preds = %8
  ...
  tail call void @llvm.memcpy.p0.p0.i64(ptr align 2 %11, ptr align 16 @staticData, i64 32, i1 false)
  br label %12
...
14:                                               ; preds = %8
  %15 = mul i64 2, %5
  %16 = tail call ptr @malloc(i64 noundef %15) #5
  %17 = tail call i32 (ptr, ...) @printf(ptr noundef @.str, i64 noundef %0, i64 noundef %0)
  %18 = mul i64 2, %5
  tail call void @llvm.memset.p0.i64(ptr align 2 %16, i8 0, i64 %18, i1 false)
  br label %19
...
21:                                               ; preds = %19
  %22 = tail call i64 @lower_StringImpl(ptr noundef %7, i64 noundef %0, ptr noundef %16)
  br label %23
...
6:                                                ; preds = %4
  ...
  %13 = tail call zeroext i16 @toASCIILower(i16 noundef zeroext %8)

...
9:                                                ; preds = %6
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 2 dereferenceable(32) %10, ptr noundef nonnull align 16 dereferenceable(32) @staticData, i64 32, i1 false)
  %11 = add i64 %7, 16
  br label %6, !llvm.loop !8

12:                                               ; preds = %6
  %13 = call ptr @malloc(i64 noundef %4) #5
...
15:                                               ; preds = %18, %12
  ...
  %17 = icmp ult i64 %16, 10000000
  br i1 %17, label %18, label %21

18:                                               ; preds = %15
  %19 = call i64 @lower_StringImpl(ptr noundef %5, i64 noundef %0, ptr noundef %13)
  %20 = add i64 %16, 1
...
8:                                                ; preds = %4
  ...
  %11 = or i16 %5, %10
  %12 = call zeroext i16 @toASCIILower(i16 noundef zeroext %10)

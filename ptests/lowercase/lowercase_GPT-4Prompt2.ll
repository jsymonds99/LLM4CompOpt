...
16:                                               ; preds = %18, %11
  %.1 = phi i64 [ 0, %11 ], [ %19, %18 ]
  %17 = icmp ult i64 %.1, 10000000
  br i1 %17, label %18, label %20

18:                                               ; preds = %16
  call fastcc void @lower_StringImpl(ptr noundef %5, i64 noundef %0, ptr noundef %13)
  %19 = add i64 %.1, 1
...
; Function Attrs: noinline nounwind uwtable
define internal fastcc void @lower_StringImpl(ptr noalias noundef %0, i64 noundef %1, ptr noalias noundef %2) unnamed_addr #0 {
  br label %4
...
6:                                                ; preds = %4
  ...
  %9 = call fastcc zeroext i16 @toASCIILower(i16 noundef zeroext %8)

...
define internal void @doTest(i64 noundef %0) #0 {
  ...
  %3 = and i64 %2, -16
  %4 = shl i64 %3, 1
  %5 = tail call ptr @malloc(i64 noundef %4) #5
  br label %6
...
11:                                               ; preds = %6
  %12 = tail call ptr @malloc(i64 noundef %4) #5
  %13 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i64 noundef %0, i64 noundef %0) #6
  tail call void @llvm.memset.p0.i64(ptr align 2 %12, i8 0, i64 %4, i1 false)
  br label %14
...
16:                                               ; preds = %14
  %17 = tail call i64 @lower_StringImpl(ptr noundef %5, i64 noundef %0, ptr noundef %12)
  %18 = add i64 %.1, 1
...
6:                                                ; preds = %4
  ...
  %9 = or i16 %.02, %8
  %10 = tail call zeroext i16 @toASCIILower(i16 noundef zeroext %8)

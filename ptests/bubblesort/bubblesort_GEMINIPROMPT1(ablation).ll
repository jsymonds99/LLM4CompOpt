...
1:                                                ; preds = %0, %14
  %lsr.iv4 = phi i64 [ -2000, %0 ], [ %lsr.iv.next, %14 ]
  %2 = call i32 @Rand()
  %.fr1 = freeze i32 %2
  ...
  %scevgep = getelementptr i8, ptr @sortlist, i64 %lsr.iv4
  %scevgep3 = getelementptr i8, ptr %scevgep, i64 2004
  store i32 %6, ptr %scevgep3, align 4
...
14:                                               ; preds = %10, %13, %9
  %lsr.iv.next = add nsw i64 %lsr.iv4, 4
  %exitcond = icmp ne i64 %lsr.iv.next, 0
  br i1 %exitcond, label %1, label %15, !llvm.loop !6
...
.preheader:                                       ; preds = %1, %8
  %indvars.iv313 = phi i64 [ 500, %1 ], [ %indvars.iv.next4, %8 ]
  %lsr.iv12 = phi i64 [ 0, %1 ], [ %lsr.iv.next, %8 ]
  %exitcond10 = icmp ne i64 %lsr.iv12, -1996
  br i1 %exitcond10, label %.lr.ph, label %8

.lr.ph:                                           ; preds = %.preheader
  br label %2

2:                                                ; preds = %.lr.ph, %7
  %lsr.iv611 = phi i64 [ -1996, %.lr.ph ], [ %lsr.iv.next7, %7 ]
  %scevgep = getelementptr i8, ptr @sortlist, i64 %lsr.iv611
  %scevgep8 = getelementptr i8, ptr %scevgep, i64 2000
  %3 = load i32, ptr %scevgep8, align 4
  %scevgep9 = getelementptr i8, ptr %scevgep, i64 2004
  %4 = load i32, ptr %scevgep9, align 4
  %5 = icmp sgt i32 %3, %4
  br i1 %5, label %6, label %7

6:                                                ; preds = %2
  store i32 %4, ptr %scevgep8, align 4
  store i32 %3, ptr %scevgep9, align 4
  br label %7

7:                                                ; preds = %6, %2
  %lsr.iv.next7 = add nsw i64 %lsr.iv611, 4
  %exitcond = icmp ne i64 %lsr.iv12, %lsr.iv.next7
  br i1 %exitcond, label %2, label %._crit_edge, !llvm.loop !8

._crit_edge:                                      ; preds = %7
  br label %8

8:                                                ; preds = %._crit_edge, %.preheader
  %indvars.iv.next4 = add nsw i64 %indvars.iv313, -1
  %lsr.iv.next = add nsw i64 %lsr.iv12, -4
  %9 = trunc i64 %indvars.iv.next4 to i32
  store i32 %9, ptr @top, align 4
  %10 = icmp ugt i64 %indvars.iv.next4, 1
  br i1 %10, label %.preheader, label %11, !llvm.loop !9

11:                                               ; preds = %8
  %12 = load i32, ptr getelementptr inbounds ([5001 x i32], ptr @sortlist, i64 0, i64 1), align 4
  %13 = load i32, ptr @littlest, align 4
  %.not = icmp eq i32 %12, %13
  br i1 %.not, label %14, label %17

14:                                               ; preds = %11
  %15 = load i32, ptr getelementptr inbounds ([5001 x i32], ptr @sortlist, i64 0, i64 500), align 16
...
18:                                               ; preds = %17, %14
  ...
  %23 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %22) #6
  ret void
}

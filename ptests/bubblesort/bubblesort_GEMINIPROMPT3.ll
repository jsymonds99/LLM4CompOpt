...
27:                                               ; preds = %26, %23
  ...
  %32 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @1, i32 noundef %31) #3
  ret void
}
...
3:                                                ; preds = %1
  tail call void @Bubble(i32 noundef %storemerge)

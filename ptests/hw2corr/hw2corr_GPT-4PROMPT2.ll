...
5:                                                ; preds = %25, %2
  %.018 = phi float [ undef, %2 ], [ %17, %25 ]
  %.017 = phi i64 [ 1, %2 ], [ %.1, %25 ]
  %.016 = phi i64 [ 1907, %2 ], [ %8, %25 ]
  %.015 = phi float [ undef, %2 ], [ %10, %25 ]
...
27:                                               ; preds = %5
  %28 = fpext float %.015 to double
  %29 = fpext float %.018 to double
  %30 = trunc i64 %.017 to i32
  %31 = trunc i64 %storemerge to i32

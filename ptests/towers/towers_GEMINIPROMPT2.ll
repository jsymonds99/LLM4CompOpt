...
7:                                                ; preds = %tailrecurse
  %.lcssa = phi i32 [ %4, %tailrecurse ]
  tail call void @Move(i32 noundef %.lcssa, i32 noundef %1)
  ret void
...
8:                                                ; preds = %tailrecurse
  ...
  %9 = add i32 %.neg4, %.neg3
  %10 = add nsw i32 %5, -1
  tail call void @tower(i32 noundef %4, i32 noundef %9, i32 noundef %10)
  tail call void @Move(i32 noundef %4, i32 noundef %1)
  br label %tailrecurse
}
...
3:                                                ; preds = %2, %0
  ...
  %5 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.5, i32 noundef %4) #5
  ret void
}
